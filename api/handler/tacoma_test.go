...
func Test_Handler_TacomaStrictMatch(t *testing.T) {
	...
	for _, tt := range [...]struct {
		...
		},
		{
			...
			expectedBody:   []byte(`[{"date":"1889-05-01","first_name":"first","last_name":"poo"},{"date":"1889-05-01","first_name":"test","last_name":"poo"},{"date":"1889-05-01","first_name":"first","last_name":"tac"}]` + "\n"),
		},
	} {
...
func Test_Handler_TacomaFuzzySearch(t *testing.T) {
	...
	for _, tt := range [...]struct {
		...
		},
		{
			...
			lastName:       "test",
			expectedStatus: http.StatusOK,
			expectedBody:   []byte(`[{"date":"1889-05-01","first_name":"first","last_name":"tac"}]` + "\n"),
		},
		{
